    ...
    <footer className="bg-card border-t border-border mt-20">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://www.instagram.com/official_playarena/" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="https://www.youtube.com/@Playarena-web" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors">
        ...
        <div className="border-t border-border mt-8 pt-8 text-center text-sm text-muted-foreground">
          <p>&copy; 2021 PlayArena. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
