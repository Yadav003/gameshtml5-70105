function CMain(oData) {
    ...
    this._initSounds = function(){
        ...
        aSoundsInfo.push({path: './sounds/',filename:'snake_eating',loop:false,volume:1, ingamename: 'snake_eating'});
        ...
        aSoundsInfo.push({path: './sounds/',filename:'snake_follow',loop:false,volume:1, ingamename: 'snake_follow'});
        aSoundsInfo.push({path: './sounds/',filename:'scream',loop:false,volume:1, ingamename: 'scream'});
